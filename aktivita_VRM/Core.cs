...
public class Core : MonoBehaviour
{
    ...
    public static (double, double) IK(double TCP_x, double TCP_y, double Q_0_actual, double Q_1_actual, double accuracy, int N)
    {
        ...
        foreach (var _ in Enumerable.Range(0, N))//z forwardu q a vypoctu eror mezi aktualnu a pozadovanu a ziskam nove q dam do doprednej mam aktualne tcp (euklid) je mensi jak presnost a kdyz ne tak 
        {
